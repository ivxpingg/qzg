        ...
        data() {
            return {
                ...
                tableColumns: [
                    ...
                    { title: '审核人', width: 120, align: 'center', key: 'auditName' },
                    { title: '通过时间', width: 150, align: 'center', key: 'passTime',
                        render: (h, params) => {
                            return h('div', this.timeFormat(params.row.passTime, 'YYYY-MM-DD HH:mm:ss'));
                        }
                    }
                ],
                tableData: [],
